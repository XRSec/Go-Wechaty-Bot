...
func logInit() {
	...
	//	hook, err := lSyslog.NewSyslogHook(viper.GetString("SYSLOG.PROTOCOL"), viper.GetString("SYSLOG.REMOTE_ADDRESS"), syslog.LOG_INFO, "WechatBot")
	//	if err != nil {
	...
	logrus.SetOutput(io.MultiWriter(os.Stdout, &lumberjack.Logger{
		Filename:   viper.GetString("LogPath") + "/wechatBot.log", //日志文件位置
